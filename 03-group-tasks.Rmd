...
Now, you’ll estimate the proportion of those who think the work of scientists does benefit them.
...
```{r MCQGT2, echo=FALSE}
opts_QGT2 <- c(answer = "Yes, the data are left skewed",
              "Yes, the data are right skewed", "No, there is no skew present")
```
